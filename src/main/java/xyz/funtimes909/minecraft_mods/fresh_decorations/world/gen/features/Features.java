...
public class Features {
  ...
  public static TagKey<Biome> OAK_BIOMES = TagKey.of(RegistryKeys.BIOME, Identifier.of(Main.ID, "has_oak_wood")); // Arrays.asList(BiomeKeys.FOREST, BiomeKeys.FLOWER_FOREST, BiomeKeys.DARK_FOREST, BiomeKeys.JUNGLE, BiomeKeys.SPARSE_JUNGLE, BiomeKeys.BAMBOO_JUNGLE, BiomeKeys.SAVANNA, BiomeKeys.SAVANNA_PLATEAU, BiomeKeys.WINDSWEPT_FOREST, BiomeKeys.SWAMP, Biomes.key_biome_oak_forest, Biomes.key_biome_big_oak_forest);
  public static TagKey<Biome> BIRCH_BIOMES = TagKey.of(RegistryKeys.BIOME, Identifier.of(Main.ID, "has_birch_wood")); // Arrays.asList(BiomeKeys.FOREST, BiomeKeys.FLOWER_FOREST, BiomeKeys.DARK_FOREST, BiomeKeys.BIRCH_FOREST, BiomeKeys.OLD_GROWTH_BIRCH_FOREST);
  public static TagKey<Biome> SPRUCE_BIOMES = TagKey.of(RegistryKeys.BIOME, Identifier.of(Main.ID, "has_spruce_wood")); // Arrays.asList(BiomeKeys.TAIGA, BiomeKeys.SNOWY_TAIGA, BiomeKeys.WINDSWEPT_FOREST, BiomeKeys.OLD_GROWTH_PINE_TAIGA, BiomeKeys.OLD_GROWTH_SPRUCE_TAIGA);
  public static TagKey<Biome> JUNGLE_BIOMES = TagKey.of(RegistryKeys.BIOME, Identifier.of(Main.ID, "has_jungle_wood")); // Arrays.asList(BiomeKeys.JUNGLE, BiomeKeys.BAMBOO_JUNGLE, BiomeKeys.SPARSE_JUNGLE);
  public static TagKey<Biome> ACACIA_BIOMES = TagKey.of(RegistryKeys.BIOME, Identifier.of(Main.ID, "has_acacia_wood")); // Arrays.asList(BiomeKeys.SAVANNA, BiomeKeys.SAVANNA_PLATEAU, BiomeKeys.WINDSWEPT_SAVANNA);
  public static TagKey<Biome> DARK_OAK_BIOMES = TagKey.of(RegistryKeys.BIOME, Identifier.of(Main.ID,"has_dark_oak_wood")); // Arrays.asList(BiomeKeys.DARK_FOREST);
  public static TagKey<Biome> BIG_ROCK = TagKey.of(RegistryKeys.BIOME, Identifier.of(Main.ID, "has_big_rock")); // Arrays.asList(BiomeKeys.DARK_FOREST);
  ...
  public static final RegistryKey<ConfiguredFeature<?, ?>> key_configured_trees_oak = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier.of(Main.ID, "trees_oak"));
  ...
  public static final RegistryKey<PlacedFeature> key_placed_trees_oak = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(Main.ID,"trees_oak"));
  ...
  public static final RegistryKey<ConfiguredFeature<?, ?>> key_configured_trees_big_oak = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier.of(Main.ID, "trees_big_oak"));
  ...
  public static final RegistryKey<PlacedFeature> key_placed_trees_big_oak = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(Main.ID, "trees_big_oak"));
  ...
  public static final RegistryKey<ConfiguredFeature<?, ?>> key_configured_cobblestone_rock = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier.of(Main.ID, "cobblestone_rock"));
  ...
  public static final RegistryKey<PlacedFeature> key_placed_cobblestone_rock = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(Main.ID, "cobblestone_rock"));
  ...
  public static final RegistryKey<ConfiguredFeature<?, ?>> key_configured_big_rock = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier.of(Main.ID, "big_rock"));
  ...
  public static final RegistryKey<PlacedFeature> key_placed_big_rock = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(Main.ID, "big_rock"));
  ...
  public static final RegistryKey<ConfiguredFeature<?, ?>> key_configured_oak_log_pile = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier.of(Main.ID, "oak_log_pile"));
  ...
  public static final RegistryKey<PlacedFeature> key_placed_oak_log_pile = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(Main.ID, "oak_log_pile"));
  ...
  public static final RegistryKey<ConfiguredFeature<?, ?>> key_configured_birch_log_pile = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier.of(Main.ID, "birch_log_pile"));
  ...
  public static final RegistryKey<PlacedFeature> key_placed_birch_log_pile = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(Main.ID, "birch_log_pile"));
  ...
  public static final RegistryKey<ConfiguredFeature<?, ?>> key_configured_spruce_log_pile = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier.of(Main.ID, "spruce_log_pile"));
  ...
  public static final RegistryKey<PlacedFeature> key_placed_spruce_log_pile = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(Main.ID, "spruce_log_pile"));
  ...
  public static final RegistryKey<ConfiguredFeature<?, ?>> key_configured_jungle_log_pile = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier.of(Main.ID, "jungle_log_pile"));
  ...
  public static final RegistryKey<PlacedFeature> key_placed_jungle_log_pile = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(Main.ID, "jungle_log_pile"));
  ...
  public static final RegistryKey<ConfiguredFeature<?, ?>> key_configured_acacia_log_pile = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier.of(Main.ID, "acacia_log_pile"));
  ...
  public static final RegistryKey<PlacedFeature> key_placed_acacia_log_pile = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(Main.ID, "acacia_log_pile"));
  ...
  public static final RegistryKey<ConfiguredFeature<?, ?>> key_configured_dark_oak_log_pile = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier.of(Main.ID, "dark_oak_log_pile"));
  ...
  public static final RegistryKey<PlacedFeature> key_placed_dark_oak_log_pile = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(Main.ID, "dark_oak_log_pile"));
  ...
  public static final RegistryKey<ConfiguredFeature<?, ?>> key_configured_oak_bush = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier.of(Main.ID, "oak_bush"));
  ...
  public static final RegistryKey<PlacedFeature> key_placed_oak_bush = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(Main.ID, "oak_bush"));
  ...
  public static final RegistryKey<ConfiguredFeature<?, ?>> key_configured_birch_bush = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier.of(Main.ID, "birch_bush"));
  ...
  public static final RegistryKey<PlacedFeature> key_placed_birch_bush = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(Main.ID, "birch_bush"));
  ...
  public static final RegistryKey<ConfiguredFeature<?, ?>> key_configured_spruce_bush = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier.of(Main.ID, "spruce_bush"));
  ...
  public static final RegistryKey<PlacedFeature> key_placed_spruce_bush = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(Main.ID, "spruce_bush"));
  ...
  public static final RegistryKey<ConfiguredFeature<?, ?>> key_configured_jungle_bush = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier.of(Main.ID, "jungle_bush"));
  ...
  public static final RegistryKey<PlacedFeature> key_placed_jungle_bush = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(Main.ID, "jungle_bush"));
  ...
  public static final RegistryKey<ConfiguredFeature<?, ?>> key_configured_acacia_bush = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier.of(Main.ID, "acacia_bush"));
  ...
  public static final RegistryKey<PlacedFeature> key_placed_acacia_bush = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(Main.ID, "acacia_bush"));
  ...
  public static final RegistryKey<ConfiguredFeature<?, ?>> key_configured_dark_oak_bush = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier.of(Main.ID, "dark_oak_bush"));
  ...
  public static final RegistryKey<PlacedFeature> key_placed_dark_oak_bush = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(Main.ID, "dark_oak_bush"));
