...
//  public static final Material MATERIAL = new Material.Builder(MapColor.OAK_TAN).lightPassesThrough().burnable().build();
  public static Block.Settings DEFAULT_SETTINGS = Block.Settings.create().strength(2.0f).sounds(BlockSoundGroup.WOOD);

//  public static final Material NETHER_MATERIAL = new Material.Builder(MapColor.OAK_TAN).lightPassesThrough().build();
  public static Block.Settings NETHER_SETTINGS = Block.Settings.create().strength(2.0f).sounds(BlockSoundGroup.NETHER_STEM);
